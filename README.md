...
- download the [.JAR file](https://github.com/DynamiteBob17/Pathfinding-Algorithms-Visualiser/raw/main/target/PathfindingVisualiser.jar) located in the "target" directory and run it  
**OR**
